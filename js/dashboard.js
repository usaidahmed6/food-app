import { FoodDisheRef, addDoc, auth, collection, db, doc, deleteDoc, getDoc, getDocs, getDownloadURL, onAuthStateChanged, onSnapshot, ref, signOut, storage, uploadBytes } from "../config/Firebase.js";
            ...
            const cardBody = `
             <div class="card-vendor-dishe"> 
                ...
                <div class="pt-3 card-content">
                 ...
                 <p class="cardPara">${disheDoc.DisheDescription}</p>
